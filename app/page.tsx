          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-8">
            <div>
              ...
              <h2 className="text-2xl text-gray-200">
                Développement web <span className="px-2 rounded inline-block" style={{ backgroundColor: "rgba(71, 150, 209)" }}>.NET React</span>
              </h2>
            </div>
        ...
        <main className="container mx-auto px-4 py-12">
          <Tabs defaultValue="experience" className="w-full">
            <TabsList className="w-full justify-start bg-white/10 text-white mb-8">
              <TabsTrigger value="experience" className="text-lg py-2 px-4">Expériences</TabsTrigger>
              <TabsTrigger value="projects" className="text-lg py-2 px-4">Projets</TabsTrigger>
              <TabsTrigger value="testimonials" className="text-lg py-2 px-4">Témoignages</TabsTrigger>
            </TabsList>
